...
public class ErrorMessage {
    @ApiModelProperty(example = "validation.tripInformation.train", required = true, value = "Составной код ошибки. Пример NotNull - код ошибки.tripInformation - объект .train - поле (не обязательно при общей ошибке валидации)", dataType = "String")
    private String code;
